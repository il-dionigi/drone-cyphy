...
def left_path(scf):
	...
	movement = sequence3[0]

	for position in sequence3:
		movement = (position[0]-position_internal[0], 
					position[1]-position_internal[1], 
					position[2], 
					position[3])
...
def right_path(scf):
	...
	movement = sequence4[0]

	for position in sequence4:
		movement = (position[0]-position_internal[0], 
					position[1]-position_internal[1], 
					position[2], 
					position[3])
